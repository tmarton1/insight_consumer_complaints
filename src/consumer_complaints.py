...
def organize_complaint_results(company_complaints,filename):
...
company_complaints=nest_complaints('complaints_med.csv')
organize_complaint_results(company_complaints,'results.csv')
